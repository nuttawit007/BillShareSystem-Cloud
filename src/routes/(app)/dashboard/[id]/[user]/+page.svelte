				...
				<Table.Root class="w-full text-sm">
					<Table.Header  class="sticky top-0 z-10 bg-slate-800">
						<Table.Row>
							...
							<Table.Head class="px-4 py-3 text-right text-white">จำนวน</Table.Head>
							<Table.Head class="px-4 py-3 text-right text-white">ราคารวม</Table.Head>
							<Table.Head class="px-4 py-3 text-right text-white">ส่วนที่ต้องจ่าย</Table.Head>
						</Table.Row>
					</Table.Header>
					<Table.Body>
						{#each items as item}
					...
					<Table.Footer class="bg-slate-50">
						<Table.Row>
							<Table.Cell class="px-4 py-3 font-medium" colspan={4}>
